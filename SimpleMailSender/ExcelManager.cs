...
namespace SimpleMailSender
{
    public static class ExcelManager
    {
        ...
        public static DataTable ToDataTable(this Stream fileStream, string sheetName = null,
        ...
        public static void SaveToExcel(string path, DataTable dt)
        {
            HSSFWorkbook book = BuildWorkbook(dt);
        ...
        private static HSSFWorkbook BuildWorkbook(DataTable dt)
        {
